...
-- style check
if not tobool(vim.g.gruvbox_italic_comment) then
    styles.italic_comment = "NONE"
end

if not tobool(vim.g.gruvbox_italic_keyword) then
    styles.italic_keyword = "NONE"
end

if not tobool(vim.g.gruvbox_italic_boolean) then
    styles.italic_boolean = "NONE"
end

if not tobool(vim.g.gruvbox_italic_function) then
    styles.italic_function = "NONE"
end

if not tobool(vim.g.gruvbox_italic_variable) then
